...
import 'package:homewardbase/screens/ForgetPasswordPage/ForgetPasswordPage.dart';
...
class _LoginPageState extends State<LoginPage> {
                    ...
                    GestureDetector(
                      onTap: () {
                        Navigator.push(
                            context,
                            MaterialPageRoute(
                                builder: (context) => RegisterPage(emailTaken)));
                      },
                      child: Text(
                        " Sign up",
                        textAlign: TextAlign.center,
  ...
  void doLogin() async {
    ...
    var res = await CallApi().withoutTokenPostData(data, 'login'); 
    ...
    if (res.statusCode != 200) {
      // show error msg
        ...
        passBlank = true;
        isPressed = false;
        passwordTxt = body['message'];//"Username or password does not match";
      });
    } else {
