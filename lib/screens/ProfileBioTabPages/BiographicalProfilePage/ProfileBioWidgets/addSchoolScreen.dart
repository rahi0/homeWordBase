              ...
              GestureDetector(
                onTap: (){
                  setState(() {
                    ...
                    schoolMobNumController.text = "";
                    mobile = "";
                    valType = "Grade (optional)";
                  });
                },
                child: Container(
          ...
          Container(
            child: Column(
              ...
              children: [
                GestureDetector(
        onTap: () {
                 pressButton == false ? null : addEducationButton();
        },
        child: Container(
   ...
   void addEducationButton() async{
    ...
    // }
     ...
     var data =    {
          ...
          'phone': schoolMobNumController.text,
          'grade': valType == "Grade (optional)" ? null : valType,
          'note': null,
          };
     //     );

       store.state.educationInfoState['education'].add(data);
