...
class AddImmunizationsScreen extends StatefulWidget {
  @override
  _AddImmunizationsScreenState createState() => _AddImmunizationsScreenState();
}

class _AddImmunizationsScreenState extends State<AddImmunizationsScreen> {
  bool pressButton = true;
  TextEditingController immunizationController = new TextEditingController();
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      bottomNavigationBar: GestureDetector(
        onTap: () {
          pressButton == false ? null : addMedicalImmuniButton();
        },
        child: Container(
      ...
      body: SingleChildScrollView(
        ...
        child: Column(
          children: [
            ////////////////////// Immunization name input field start //////////////////////////
            Container(
                width: MediaQuery.of(context).size.width,
                    ...
                    Flexible(
                      child: TextField(
                        ...
                        decoration: InputDecoration(
                          hintText: "Enter immunization name",
                          hintStyle: TextStyle(
                              color: Color(0xff003A5B).withOpacity(0.6),
                              fontSize: 15,
                              fontFamily: 'quicksand',
            ...
            ////////////////////// Immunization name input field end //////////////////////////
...
void addMedicalImmuniButton() async{

    setState(() {
      pressButton = false;
    });

    if(immunizationController.text == ""){
     ...
     var data =    {
          'id' : 0,
          'title' : immunizationController.text,
          'description': notesController.text,
          'date': "${selectedDateTo}".split(' ')[0]
          };
     //     );

       store.state.medicalInfoState['Immunization'].add(data);
       immunizationList.add(data);
