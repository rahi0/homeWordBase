...
class GeneralRaceSelectionScreen extends StatefulWidget {
  @override
  _GeneralRaceSelectionScreenState createState() =>
      _GeneralRaceSelectionScreenState();
}

class _GeneralRaceSelectionScreenState
    extends State<GeneralRaceSelectionScreen> {
  List raceList = [
    {'race': 'Asian'},
    {'race': 'Black / African'},
    {'race': 'Caucasian'},
      ...
      body: SingleChildScrollView(
        ...
        child: Column(
          ...
          return GestureDetector(
            onTap: () {
              setState(() {
                if (genRace == raceList[index]['race']) {
                  genRace = "";
                } else {
                  genRace = raceList[index]['race'];
                }
                print(genRace);
              });
            },
