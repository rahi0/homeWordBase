...
class AddDentalConditionScreen extends StatefulWidget {
  @override
  _AddDentalConditionScreenState createState() =>
      _AddDentalConditionScreenState();
}

class _AddDentalConditionScreenState extends State<AddDentalConditionScreen> {
