...
class AddDentalCareProviders extends StatefulWidget { 
  @override
  _AddDentalCareProvidersState createState() => _AddDentalCareProvidersState();
}

class _AddDentalCareProvidersState extends State<AddDentalCareProviders> {
   bool isFName = true;
  bool isLName = true;
...
void addDoctorButton() async{
    ...
    if(fNameController.text == ""){
     ...
     var data =    {
       ...
       store.state.dentalInfoState['doctor'].add(data);
       dentalDocList.add(data);
