...
class UpdateDoctorScreen extends StatefulWidget {
  final medicalDocData;
  final medicalDocIndex;
  UpdateDoctorScreen(this.medicalDocData, this.medicalDocIndex);
  @override
...
class _UpdateDoctorScreenState extends State<UpdateDoctorScreen> {
 ...
 void getMedicalDocData() async {
   setState(() {
     isLoading = true;
   });
   print(widget.medicalDocIndex);
   fNameController.text = store.state.medicalInfoState['doctor'][widget.medicalDocIndex]['name'];
   addressController.text = store.state.medicalInfoState['doctor'][widget.medicalDocIndex]['address'];
   mobNumController.text = store.state.medicalInfoState['doctor'][widget.medicalDocIndex]['phone_number'];
   typeController.text = store.state.medicalInfoState['doctor'][widget.medicalDocIndex]['department'];
   setState(() {
     isLoading = false;
   });
 }
...
void addDoctorButton() async{
    ...
    store.state.medicalInfoState['doctor'][widget.medicalDocIndex]['name'] = fNameController.text;
    store.state.medicalInfoState['doctor'][widget.medicalDocIndex]['address'] = addressController.text;
    store.state.medicalInfoState['doctor'][widget.medicalDocIndex]['phone_number'] = mobNumController.text;
    store.state.medicalInfoState['doctor'][widget.medicalDocIndex]['department'] = typeController.text;

    setState(() {
      doctorList[widget.medicalDocIndex]['name'] = fNameController.text;
      doctorList[widget.medicalDocIndex]['address'] = addressController.text;
      doctorList[widget.medicalDocIndex]['phone_number'] = mobNumController.text;
      doctorList[widget.medicalDocIndex]['department'] = typeController.text;
    });
   store.dispatch(MedicalInfoAction(store.state.medicalInfoState));

      // print(store.state.medicalInfoState['doctor']);
      // print('did');
      // print(doctorList);
